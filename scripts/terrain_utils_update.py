...
def sand_dune_terrain(terrain, dune_height=12, dune_length_ratio=1, obstacle_height=20., obstacle_width_ratio=0.1, num_dunes=2):
    ...
    heightfield[:,int(2*terrain.length/5):int(3*terrain.length/5)] = dune(dune_height*0.03/terrain.vertical_scale, terrain.length/5)
    heightfield[:,int(3*terrain.length/5):int(4*terrain.length/5)] = dune(dune_height*0.03/terrain.vertical_scale, terrain.length/5)
    # heightfield[:,int(4*terrain.length/5):int(terrain.length)] = dune(dune_height, terrain.length/5)
    # Create the ledge
    heightfield[int(terrain.width/2):,:int(terrain.length/5)]=0.3/terrain.vertical_scale
    heightfield[int(terrain.width/2):,int(terrain.length/5):int(2*terrain.length/5)]=2*0.3/terrain.vertical_scale
    ...
    heightfield[int(terrain.width/2):,int(4*terrain.length/5):]=3*0.3/terrain.vertical_scale
